...
<h5>🎋 개발 과정간 주요 고민 사항
<p> 개발 초기 팀원과의 소통이 원활히 되지 않아 여러가지 방법을 고민했습니다.</p>
<ul>
    <li>팀원 과의 개발 간극을 맞추기 위해 협업 툴인 Figma 사용</li>
    <li>프론트 / 백엔드 간의 소통을 위해 API 명세서 작성</li>
    <li>주 마다 코드 리뷰를 통해 더 나은 해결방안을 찾고 이를 프로젝트에 적용</li>
</ul><hr>
