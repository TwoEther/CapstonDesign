...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v==sign_up) {
            Intent startIntent = new Intent(LoginActivity.this, com.example.capstonproject.RegisterActivity.class);
            startActivity(startIntent);
        }
        else if(v==forgot_pass){
            Intent startIntent = new Intent(LoginActivity.this, com.example.capstonproject.ResetPasswordActivity.class);
            startActivity(startIntent);
        }
        else if(v==login) {
