...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.tv_amount_of_dishes.setText(Float.toString(mData.get(position).getcalories()) );
        holder.tv_calories_in_mins.setText(mData.get(position).getkind());
...
//            Picasso.get().load(mData.get(position).getThumbnail()).into(holder.img_recipe_thumbnail);
            Picasso.get().load(mData.get(position).getThumbnail()).error(R.drawable.another_logo).into(holder.img_recipe_thumbnail);
        }
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("seq",mData.get(position).getSeq());
...
//                intent.putExtra("img",mData.get(position).getThumbnail());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_recipe_title,tv_amount_of_dishes,tv_calories_in_mins;
        ...
        public MyViewHolder(View itemView) {
            ...
            tv_calories_in_mins = (TextView) itemView.findViewById(R.id.readyInTvRight);
