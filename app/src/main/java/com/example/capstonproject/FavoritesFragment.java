            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (favorites != null) {
                    for (Object recipe : favorites.keySet()) {
                        ...
                        String seq = (String) dataSnapshot.child(recipe.toString()).child("seq").getValue();
                        String img = (String) dataSnapshot.child(recipe.toString()).child("img").getValue();
                        String kind = (String) dataSnapshot.child(recipe.toString()).child("kind").getValue();
                        Float calories = (Float) dataSnapshot.child(recipe.toString()).child("calories").getValue();
                        lstFavorites.add(new Recipe(seq, recipe.toString(), title, img, calories, kind));
                    }
                }
